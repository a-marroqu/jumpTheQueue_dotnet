...
using Devon4Net.Application.WebAPI.Business.VisitorManagement.Validators;
...
namespace Devon4Net.Application.WebAPI.Configuration
{
    ...
    public static class DevonConfiguration
    {
        ...
        private static void SetupFluentValidators(IServiceCollection services)
        {
            ...
            services.AddFluentValidation<IValidator<VisitorDto>, VisitorFluentValidator>();
        }
        ...
        private static void SetupDatabase(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.SetupDatabase<VisitorContext>(configuration, "Visitor", DatabaseType.InMemory).ConfigureAwait(false);
            services.SetupDatabase<DailyQueueContext>(configuration, "DailyQueue", DatabaseType.InMemory).ConfigureAwait(false);
            services.SetupDatabase<AccessCodeContext>(configuration, "AccessCode", DatabaseType.InMemory).ConfigureAwait(false);
        }
